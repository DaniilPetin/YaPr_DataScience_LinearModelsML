...
**Основной стек инструментов: Python (pandas, NumPy, SciPy, Matplotlib, Seaborn, Scikit-learn, Phik), Jupyter, CSV, статистический анализ (φ-коэффициент, корреляционный анализ, t-распределение), теория вероятностей, машинное обучение (линейная регрессия, логистическая регрессия), метрики качества (R², MAE, MSE, accuracy, precision, recall, матрица ошибок).**
